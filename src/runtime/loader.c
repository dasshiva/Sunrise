...
char* syslib[2][SYSLIB_SZ] = {
  { "java/lang/Object", "java/lang/String", "java/lang/System", "java/io/PrintStream", "java/lang/Exception", "java/lang/RuntimeException", "java/lang/ArrayIndexOutOfBoundsException", "java/lang/StringIndexOutOfBoundsException", "java/io/InputStream", "java/lang/Math", NULL}, 
  { "syslib/VMObjExt", "syslib/VMStr", "syslib/VMSys", "syslib/VMPrtStream", "syslib/VMEx", "syslib/VMRtEx", "syslib/VMArrIndEx", "syslib/VMStrIndEx", "syslib/VMIStream", "syslib/VMMath", NULL }
};
